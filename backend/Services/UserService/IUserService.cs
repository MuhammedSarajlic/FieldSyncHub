...
public interface IUserService
{
    ...
    Task<ApiResponse<GetUserDto>> GetUserById(Guid userId, Guid callerWorkspaceId);
    Task<ApiResponse<GetUserDto>> GetUserByEmail(string email, Guid callerWorkspaceId);
