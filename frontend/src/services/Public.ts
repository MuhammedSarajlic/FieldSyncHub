...
export const createPortalPaymentIntent = (token: string) => publicApi.post(`/portal/${encodeURIComponent(token)}/payment-intent`, null, { headers: { 'Idempotency-Key': crypto.randomUUID() } });
